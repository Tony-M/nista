...
{    
    ...
    if(file_exists("../../../../../includes/lib/func_mysql_lib.php"))require_once("../../../../../includes/lib/func_mysql_lib.php");
    if(class_exists ("mysql_manager"))
    {
        if(!mysql_manager::db_connect())
        {
            header("Location: http://".$_SERVER['SERVER_NAME']."/userMain/index.php?todo=login");
            exit;
        }        
    }
    else
    ...
    if(file_exists("../../../../../includes/lib/user_manager_lib.php"))require_once("../../../../../includes/lib/user_manager_lib.php");
    {    
    ...
    if(($_SESSION['UID'] ==0) || ( !is_numeric($_SESSION['UID'])))
    {
        header("Location: http://".$_SERVER['SERVER_NAME']."/userMain/index.php?todo=login");
        @session_destroy();
        exit;
...
$IMConfig['images_dir'] = "../../../../../src/img/users/".$_SESSION['UID'];///////////"demo_images";
...
$IMConfig['images_url'] = "http://".$_SERVER['SERVER_NAME']."/src/img/users/".$_SESSION['UID'];////////////str_replace( "backend.php", "", $_SERVER["PHP_SELF"] ) . "demo_images";
