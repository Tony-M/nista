...
*/
$IMConfig['images_dir'] = '../src/img/users/'.$_SESSION['ID']//////'demo_images';
...
*/
$IMConfig['images_url'] = "src/img/users/".$_SESSION['ID'];///// = str_replace( array("backend.php","manager.php"), "", $_SERVER["PHP_SELF"] ) . $IMConfig['images_dir'];
