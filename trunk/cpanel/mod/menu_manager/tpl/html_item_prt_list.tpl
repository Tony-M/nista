<table border="0" cellspacing="1" cellpadding="0" width="100%" class="table_body">
	...
	<tr class="tr">
		...
		<td class="td_body"><a index="#" >{if $DOCUMENT.mod.data.partitions[item_prt_num].prt_id != 0}{$DOCUMENT.mod.data.partitions[item_prt_num].partition.title}{else}Все разделы{/if}</a>[x]</td>
